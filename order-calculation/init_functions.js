...
function get_important_columns() {
  ...
  var names = ["PN", "Model", "Part", "Make", "Category", "Existing Priority", "Priority", "Total Qty on Hand", "Total Forecast Qty", "Total Qty Available", "Min Qty", "Max Qty", "Target Qty", "Market Price", "Margin %", "Est Av Pur Price", "Base Cost"];
