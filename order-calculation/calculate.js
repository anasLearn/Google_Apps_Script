...
function calculate_orders() {
  ...
  var forecast_qty = orderSheet.getRange(start, names_dict["Total Forecast Qty"], num_products ,1).getValues();
  var qty_available = orderSheet.getRange(start, names_dict["Total Qty Available"], num_products ,1).getValues();
